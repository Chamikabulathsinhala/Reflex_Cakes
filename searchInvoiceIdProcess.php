...
?>
        <div class="row">
            ...
            <div class="col-2 bg-white d-grid">
                ...
                ?>
                    <button class="btn btn-info fw-bold mt-1 mb-1" onclick="changeStatus('<?php echo $invoice_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Dispatch</button>
                <?php
                ...
                ?>
                    <button class="btn btn-danger fw-bold mt-1 mb-1 disabled" onclick="changeStatus('<?php echo $invoice_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Deliverd</button>
                <?php
                }
                ?>
