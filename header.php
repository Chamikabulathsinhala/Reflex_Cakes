        ...
        <div class="row mt-1 mb-1">
            ...
            <div class="offset-lg-1 col-12 col-lg-4 align-self-start mt-2">
                ...
                ?>
                    ...
                    <span class="text-lg-start text-light"><b>Welcome </b><?php echo $data["fname"]; ?></span> |
                    <span class="text-lg-start text-light fw-bold signout" onclick="signout();">Sign Out</span> |
                ...
                ?>
                    ...
                    <a href="index.php" class=" text-light fw-bold">Sign In or Register</a> |
                ...
                <span class="text-lg-start text-light fw-bold">Help and Contact</span>
                ...
                <div class="row">
                    ...
                    <div class="col-3 col-lg-6 dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            if (isset($_SESSION["u"])) {
                            ?>
                                <li><a class="dropdown-item" href="#" onclick="contatcAdmin('<?php echo $_SESSION['u']['email']; ?>');">Contact Admin</a></li>
                            <?php
