            ...
            ?>
                ...
                <div class="col-12 border border-1 border-primary rounded mb-3">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <label class="form-label fs-1 fw-bolder">Shoping Cart </label>
                        </div>
                        ...
                        ?>
                                        ...
                                        <div class="card mb-3 mx-0 col-12 ">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <span class="" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="<?php echo $product_data["description"]; ?>" title="Product Details">
                                                        ...
                                                        <img src="<?php echo $image_data["code"]; ?>" class="image-box" style="height:120px; width:160px;">
                                                    </span>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <span class="fw-bold text-black-50 fs-4">Quantity :</span>&nbsp;<br>
                            ...
                            <div class="d-none col-lg-1 mt-3"></div>
