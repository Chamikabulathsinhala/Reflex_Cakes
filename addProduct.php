        ...
        <div class="row gy-3">
            ...
            <!-- <p> <a href="home.php">home</a> / checkout </p> -->
                        ...
                        <div class="col-12 text-center">
                            <h2 class="h2 fw-bold" style="background-color: purple;">Add New Product</h2>
                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-check form-check-inline mx-5">
                                                        ...
                                                        <label class="form-check-label fw-bold" for="b">with Fondant layer</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" id="u" name="c" />
                                                        <label class="form-check-label fw-bold" for="u">Without fondant layer</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <textarea cols="2" rows="2" class="form-control" id="desc"></textarea>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.svg" class="img-fluid" style="height: 100px;" id="i0" />
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.svg" class="img-fluid" style="height: 100px;" id="i1" />
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.svg" class="img-fluid" style="height: 100px;" id="i2" />
                                                </div>
                                            </div>
                                        </div>
