...
if($category == "0"){
    ...
    (`category_id`,`price`,`qty`,`description`,`title`,`condition_id`,`status_id`,`user_email`,
    `datetime_added`,`delivery_fee_colombo`,`delivery_fee_other`,`colour_id`,`brand_has_model_id`) VALUES 
    ('".$category."','".$cost."','".$qty."','".$desc."','".$title."','".$condition."','".$status."','".$email."',
    '".$date."','".$dwc."','".$doc."','".$clr."','".$brand_has_model_id."')");
