...
?>
    ...
    <div class="offset-2 offset-md-1 offset-lg-0 col-8 card mt-2 mb-2 align-items-center gap-md-5 ms-lg-4" style="width: 18rem;">
        ...
        <div class="card-body ms-0 m-0 text-center mt-3">
            <h5 class="card-title fs-6 fw-bold"><?php echo $results_data["title"]; ?> <span class="badge bg-info">New</span></h5>
            ...
            ?>
                ...
                <span class="card-text text-success fw-bold"><?php echo $results_data["qty"]; ?> Items Left</span><br /><br />
            ...
            <button class="col-12 btn btn-outline-light mt-2"><i class="bi bi-heart text-danger fs-5"></i></button>
        </div>
    </div>
