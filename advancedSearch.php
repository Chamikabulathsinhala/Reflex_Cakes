...
<body class="bg-info">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="offset-lg-2 col-12 col-lg-8 bg-body rounded mb-2">
                <div class="row">
                    <div class="offset-lg-8 offset-4 col-lg-4 col-8 mt-2 mb-2">
                        <select class="form-select border border-start-0 border-top-0 border-end-0 border-2 border-primary rounded-0 shadow-none" id="s">
            ...
            <div class="offset-lg-2 col-12 col-lg-8 bg-body mb-5">
                <div class="row">
