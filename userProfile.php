    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12" style="background-color: #702963;">
                    <div class="row">
                        <div class="menu-heading">
                            <h3 class="fw-bold text-dark">User Profile...</h3>
                        ...
                        <div class="col-12 bg-body rounded mt-4 mb-4">
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 border-end" style="background-color: #E6E6FA">
                                ...
                                <div class="col-md-5 border-end">
                                    <div class="p-3 py-5" style="background-color: #702963;">
                                ...
                                <div class="col-md-4 text-center" style="background-color: #E6E6FA">
                                    <!-- <div class="row">
