    ...
    <div class="container-fluid">
        <div class="row">
            <div class="menu-heading">
                <h3 class="fw-bold text-dark">Manage All Items...</h3>
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label text-dark fw-bold fs-1">Manage All Items</label>
            </div>
            <div class="col-6">
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-lg-block bg-warning ">
                ...
                ?>
                    ...
                    <div class="col-12 mt-3 mb-3">
                        <div class="row">
                            <div class="col-1 col-lg-1 bg-secondary py-2 text-end">
                                <span class="fs-4 fw-bold text-white"><?php echo $selected_data["id"]; ?></span>
                            </div>
                            <div class="col-2 m-lg-1" onclick="viewProductModal('<?php echo $selected_data['id']; ?>');">
                                <?php
                                $image_rs = Database::search("SELECT * FROM `images` WHERE `product_id`='" . $selected_data["id"] . "'");
                                $image_num = $image_rs->num_rows;
                                if ($image_num == 0) {
                                ?>
                                    <img src="resource/mobile_images/iphone12.jpg" style="height: 40px;" />
                                <?php
                                } else {
            ...
            <div class="col-5">
                ...
                <div class="col-12 mb-3">
                    <div class="row gap-3 ">
                        ...
                        ?>
                            <div class="col-10 bg-light border  rounded" style="height: 100px;">
                                <div class="row">
                                    <div class="col-12 mt-2 mb-2">
                                        <label class="form-label fw-bold fs-1"><?php echo $category_data["name"]; ?></label>
                                    </div>
                                    
                                </div>
                            </div>
                            <div class="col-2 border-start border-secondary text-center mt-2 mb-2">
                                        <label class="form-label fs-4"><i class="bi bi-trash3-fill text-warning"></i></label>
                                    </div>
                        <?php
                        }
                        ?>

                        <div class="col-12 col-lg-3 border border-light rounded" style="height: 100px;" onclick="addNewCategory();">
                            <div class="row">
                                <div class="col-8 mt-2 mb-2">
                                    <label class="form-label text-light fw-bold fs-5">Add new Category</label>
                                </div>
